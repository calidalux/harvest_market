...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#222222" style="margin:0; padding:0; -webkit-text-size-adjust:none; -ms-text-size-adjust:none;">
	<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" bgcolor="#fff" style="border-collapse:collapse;"><tr><td>
		...
		<table border="0" width="600" cellpadding="0" cellspacing="0" align="center" style="width:600px; margin: auto;" class="email-container">
					...
					<table border="0" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td valign="middle" width="150" style="padding:5px 0; text-align:left; line-height: 1;" class="stack-column-center">
								<a href="http://harvestltd.ru"><img src="http://harvestltd.ru/email/mail_logo.png" alt="Харвест" width="150" height="50" border="0" style="display: block; margin: auto;"></a>
							</td>
							<td valign="middle" style="padding:5px 0; text-align:right; line-height:1.1; font-family: sans-serif; font-size: 13px; color: #999999;" class="stack-column-center">
								<span style="font-size: 14px; color: #c93444; font-weight: bold; " >harvestltd.ru</span><br>
							</td>
						</tr>
						<tr><td height="5" style="font-size: 0; line-height: 0;">&nbsp;</td></tr>
					</table>
					...
					<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
						...
						<tr>
							<td valign="middle" align="center">
								<img src="http://harvestltd.ru/email/mail_main.png" alt="alt text" height="300" width="600" align="center" border="0" style="margin: auto;" class="fluid">
							</td>
						</tr>
						...
						<tr>
							<td style="padding: 4%; font-family: sans-serif; font-size: 18px; line-height: 1.3; color: #666666;">
								Поставка грузовых, сельскохозяйственных и индустриальных шин по всей РФ.
							</td>
						</tr>
							<tr>
								<td style=" background: #c93444; text-align: center;">
									<a href="http://harvestltd.ru" style="background: #c93444; border: 15px solid #c93444; padding: 0 10px;color: #ffffff; font-family: sans-serif; font-size: 15px; line-height: 1; text-align: center; text-decoration: none; display: block;">
										<b><!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->ПЕРЕЙТИ В КАТАЛОГ<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--></b>
									</a>
								</td>
							</tr>
			...
			<tr>
				<td style="text-align:center; padding:4% 0; font-family:sans-serif; font-size:13px; line-height:1.2; color:#666666;">
					...
					ООО "Харвест"; <span class="mobile-link--footer">г. Саратов, ул. Песчано-Умётская 39</span> &bull; <span class="mobile-link--footer">8 (8452) 33-88-50</span>
					<br><br>
				</td>
			</tr>
			<!-- Footer : END -->
